...
public class NewUser implements Initializable {
    ...
    @FXML
    private JFXPasswordField verification_password;
    @FXML
    private JFXTextField ccn;
    @FXML
    ...
    @FXML
    private JFXTextField bankID;
    @FXML
    private JFXPasswordField cvpassword;
    @FXML
    private JFXTextField FirstName;
    @FXML
    private JFXTextField ssn1;
    @FXML
                ...
                )
        {
          ...
          else
          {
             ...
             Statement stmt = connection.createStatement();
              ...
              String insertuserdata = "insert into user values('"+this.ssn1.getText()+"','"+this.FirstName.getText()+"','"+this.LastName.getText()+"','"+
